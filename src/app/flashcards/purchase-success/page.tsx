      ...
      <Card className="p-8">
        ...
        {status === 'completed' && (
          <>
            ...
            <p className="mt-2 text-sm text-ink-500">The flashcard set is now unlocked.</p>
            <Button className="mt-6" onClick={() => router.push(`/flashcards/${setId}`)}>
              Go to flashcards
            </Button>
          </>
        )}
...
export default function FlashcardPurchaseSuccessPage() {
  return (
    <Suspense
      fallback={
        <div className="mx-auto max-w-md px-6 py-24 text-center">
